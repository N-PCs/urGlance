    ...
    <nav className="navbar" id="navbar">
      <div className="container navbar-inner">
        <a href="#" className="navbar-logo" onClick={() => setOpen(false)}>
          ...
          <span className="gradient-text" style={{fontSize:"25px"}}>urGlance</span>
        </a>

        <div className="navbar-links">
          <a href="#features">Features</a>
          <a href="#how-it-works">How It Works</a>
          <a href="#downloads" style={{background:"var(--accent)", color:"black", height:"25px", width:"80px", borderRadius:"7px", textAlign:"center" }}>Downloads</a>
        </div>
